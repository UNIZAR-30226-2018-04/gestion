...
\begin{figure}[H]
  \includegraphics[width=\linewidth]{figuras/mapaFinal}
...
momento en el que es imposible evitar el mandar el estado completo es en la transición de idas a vueltas. El diagrama de secuencias correspondiente a una partida completa se muestra en la figura \ref{fig:partidaCompleta1}\\

Como caso interesante se encuentra la desconexión/reconexión de jugadores, que se gestiona notificando al resto de jugadores
...
el jugador ha expirado su tiempo, finalizando la partida y notificando a los jugadores. El diagrama de secuecias correspondiente al caso de desconexión/reconexión de un jugador se observa en la figura \ref{fig:desconexion}.\\

Finalmente, el otro caso interesante es la gestión de los espectadores, que básicamente son tratados como jugadores en el sentido de que son
...
ya que no influye para el desarrollo de la partida. Su diagrama de secuencias se muestra en la figura \ref{fig:espectador}.\\
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.6]{figuras/statsIA}
